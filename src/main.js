...
<header class="header"><a class="brand" href="/" aria-label="GYS İçişleri ana sayfa"><span class="brand-icon">${svg('book')}</span><span>GYS <strong>İçişleri</strong><small>SINAVA HAZIRLIK</small></span></a><span class="header-note">Ücretsiz puan hesaplama</span></header>
